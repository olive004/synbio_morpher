...
from src.utils.misc.io import get_path_from_exp_summary, get_pathnames, load_experiment_report, load_experiment_output_summary
...
def tabulate_mutation_info(source_dir):
    ...
    for circuit_dir in dirs:
        ...
        for mutation_dir in mutation_dirs:
            ...
            info_table['mutation_name'] = mutations['mutation_name']
            info_talbe['source_specie'] = 
            ...
            info_table['mutation_type'] = mutations[mutations['mutation_name']
                                                    == mutation_dir]['mutation_type']
